...
public class Book {
    ...
    private final long isbn; // почему final? - что бы его никто не мог поменять после создания книги
    ...
    public Book(String title, String author, int yearOfPublishing, long isbn) {
        ...
        this.isbn = isbn; // проверка ISBN
    }

    // конструктор без автора, на случай, когда автора нет
    ...
    public String toString() {
        return  "title=: " + title +  ", author: " + author +  ", yearOfPublishing: " + yearOfPublishing + ", isbn: " + isbn ;
    }
